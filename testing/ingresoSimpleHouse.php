    ...
    <body class="bg-light">
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate action="../IngresoSimple/House" method="get" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label for="firstName">Guía House</label>
