    ...
    <body class="bg-light">
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate action="../Salida/Solicitud/Master" method="get" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="lastName">Pedimento</label>
                            <input type="text" class="form-control" id="pedimento" name="pedimento" placeholder="" value="" required>
                            <div class="invalid-feedback">
                                El Pedimento es requerido.
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="lastName">Patente</label>
                            <input type="text" class="form-control" id="patente" name="patente" placeholder="" value="" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="lastName">Cve de Pedimento</label>
                            <input type="text" class="form-control" id="cvePedimento" name="cvePedimento" placeholder="" value="" required>
                            <div class="invalid-feedback">
                                La CVE del Pedimento es requerida.
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="lastName">Guia Master</label>
                            <input type="text" class="form-control" id="numMaster" name="numMaster" placeholder="" value="" required>
                            <div class="invalid-feedback">
                                La Guía Master es requerida.
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="numPiezas" name="numPiezas" placeholder="" value="" required>
                            <div class="invalid-feedback">
                                Las Piezas es requerida.
                            </div>
                        </div>
                        <div class="col-md-6">
