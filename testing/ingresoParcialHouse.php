    ...
    <body class="bg-light">
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate action="../IngresoParcial/House" method="get" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label for="lastName">Guía House</label>
                            <input type="text" class="form-control" id="guiaHouse" name="guiaHouse" placeholder="" value="" required>
                            <div class="invalid-feedback">
                                La Guía House es requerida.
                            </div>
                        </div>
                    </div>
                    <br>
